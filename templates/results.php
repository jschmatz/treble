    ...
    <ul class="results col-xs-16">
        <li class="result featured col-xs-8">
            <div class="pic_ratings col-xs-4">
                <a href="<?php echo __ROOT_DIR__; ?>/musician">
            ...
            <div class="info col-xs-12">
                <h3><a href="<?php echo __ROOT_DIR__; ?>/musician">Featured Profile 1 Name</a></h3>
                <ul>
                    <li>Instrument(s): Guitar, Drums</li>
                    <li>Size of Group: 154</li>
                    <li>City: Anytown, USA</li>
                    <li>Hourly Rate: $1,000.00</li>
                    <li><a href="<?php echo __ROOT_DIR__; ?>/musician#audio_samples">Audio Preview</a></li>
                </ul>
            </div>
        </li>
        <li class="result featured col-xs-8">
        ...
        <li class="result col-xs-8">
            ...
            <div class="info col-xs-12">
                <h3><a href="<?php echo __ROOT_DIR__; ?>/musician">Profile 1 Name</a></h3>
                <ul>
                    <li>Instrument(s): Guitar, Drums</li>
                    <li>Size of Group: 154</li>
                    <li>City: Anytown, USA</li>
